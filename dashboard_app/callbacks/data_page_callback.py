...
def toggle_emissions_collapse(n, is_open):
    if n:
        if is_open:
            return False, [
...
@callback(
    ...
    [Input("data-flow-diagram", "n_clicks"), Input("close-diagram-modal", "n_clicks")],
    [State("diagram-modal", "is_open")],
    prevent_initial_call=True,
)
def toggle_diagram_modal(n_diagram, n_close, is_open):
