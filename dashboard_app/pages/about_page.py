    ...
    content = html.Div(
        [
            dbc.Row(
                [
                    dbc.Col(
                        html.H3("About the Dashboard", className="text-center mb-2"),
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                ...
                                className="mb-3 border-start border-secondary border-1, ms-4",
                            ),
                        ],
                        md=6,
                    ),
